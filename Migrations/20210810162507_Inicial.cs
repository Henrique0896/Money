        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nome = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ValorContido = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    UsuarioId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RendaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rendas", x => x.RendaId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Finalidades", x => x.FinalidadeId);
                    table.ForeignKey(
                        name: "FK_Finalidades_Contas_ContaId",
                        column: x => x.ContaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Finalidades_ContaId",
                table: "Finalidades",
                column: "ContaId");

            migrationBuilder.CreateIndex(
                name: "IX_Finalidades_UsuarioId",
                table: "Finalidades",
                column: "UsuarioId");
